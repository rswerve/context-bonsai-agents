...
| Codex | Verified | Integrated into the Codex fork. A live logged-in sprite build verified tool registration, ambiguity rejection, prune/retrieve, and Protocol A. Gauge cadence was not exercised. | [Codex Context Bonsai installation](https://github.com/Vibecodelicious/codex_context_bonsai#installation) |
